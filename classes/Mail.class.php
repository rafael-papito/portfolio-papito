<?php
	class Mail{
		...
		public $opt,$mailer;
		public $email = 'rafaelporto@papitocode.com';//Trocar e-mail aqui!
		public $senha = '$PortoPapito2525';//Trocar senha aqui!
		...
		public function __construct(Array $parametros){
			...
			$this->mailer->IsSMTP();
			$this->mailer->Host = 'papitocode.com'; //SERVIDOR SMTP DA HOSPEDAGEM
